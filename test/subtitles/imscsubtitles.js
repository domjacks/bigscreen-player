import Squire from 'squire';
    describe('IMSC Subtitles', () => {
      ...
      describe('Vod subtitles', () => {
        ...
        it('Should load the captions url', () => {
          subtitles = ImscSubtitles(mediaPlayer, stubCaptions, true, mockParentElement);
        ...
        it('fires onSubtitlesLoadError plugin if loading of XML fails', () => {
          loadUrlMock.and.callFake(function (url, callbackObject) {
        ...
        it('does not attempt to load subtitles if there is no captions url', () => {
      ...
      describe('Live subtitles', () => {
        ...
        describe('Loading fragments', () => {
          ...
          it('should load the fragment two segments ahead of current time', () => {
          ...
          it('should not load a fragment if fragments array already contains it', () => {
            subtitles = ImscSubtitles(mediaPlayer, stubCaptions, true, mockParentElement, {}, epochStartTimeSeconds);
          ...
          it('only keeps three fragments when playing', () => {
            subtitles = ImscSubtitles(mediaPlayer, stubCaptions, true, mockParentElement, {}, epochStartTimeSeconds);
          ...
          it('load three new fragments when seeking back to a point where none of the segments are available', () => {
            subtitles = ImscSubtitles(mediaPlayer, stubCaptions, true, mockParentElement, {}, epochStartTimeSeconds);
          ...
          it('loads three new fragments when seeking forwards to a point where none of the segments are available', () => {
            subtitles = ImscSubtitles(mediaPlayer, stubCaptions, true, mockParentElement, {}, epochStartTimeSeconds);
          ...
          it('should not load fragments when auto start is false', () => {
          ...
          it('should load fragments when start is called and autoStart is false', () => {
            subtitles = ImscSubtitles(mediaPlayer, stubCaptions, false, mockParentElement, {}, epochStartTimeSeconds);
          ...
          it('should stop loading fragments when stop is called', () => {
            subtitles = ImscSubtitles(mediaPlayer, stubCaptions, true, mockParentElement, {}, epochStartTimeSeconds);
          ...
          it('should stop loading fragments when xml transforming has failed', () => {
            imscMock.fromXML.and.throwError();
          ...
          it('should stop loading fragments when the XML fails to load', () => {
            loadUrlMock.and.callFake(function (url, callbackObject) {
              callbackObject.onError();
            });
          ...
          it('should not stop loading fragments when the xml response is invalid', () => {
            loadUrlMock.and.callFake(function (url, callbackObject) {
              callbackObject.onLoad(null, '', 200);
            });
