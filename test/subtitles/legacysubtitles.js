...
import TransportControlPosition from 'bigscreenplayer/models/transportcontrolposition';
    ...
    describe('Legacy Subtitles', () => {
      ...
      it('Should fire onSubtitlesLoadError plugin if loading of XML fails', () => {
        loadUrlMock.and.callFake(function (url, callbackObject) {
      ...
      it('Should fire subtitleTransformError if responseXML from the loader is invalid', () => {
        loadUrlMock.and.callFake(function (url, callbackObject) {
      ...
      describe('Start', () => {
        it('Starts if there is valid xml in the response object', () => {
          legacySubtitles = LegacySubtitlesWithMocks(null, stubCaptions, false, parentElement);
        ...
        it('Does not start subtitles if there is invalid xml in the response object', () => {
          loadUrlMock.and.callFake(function (url, callbackObject) {
            callbackObject.onError();
          });
          legacySubtitles = LegacySubtitlesWithMocks(null, stubCaptions, false, parentElement);
      ...
      describe('Updating position', () => {
        ...
        [
          ...
          it('Has class ' + position.className + ' for position ' + position.pos, () => {
