...
import PlayerComponent from 'bigscreenplayer/playercomponent';
import PauseTriggers from 'bigscreenplayer/models/pausetriggers';
...
import MockBigscreenPlayer from 'bigscreenplayer/mockbigscreenplayer';
import Plugins from 'bigscreenplayer/plugins';
import Chronicle from 'bigscreenplayer/debugger/chronicle';
import DebugTool from 'bigscreenplayer/debugger/debugtool';
import SlidingWindowUtils from 'bigscreenplayer/utils/timeutils';
import MediaSources from 'bigscreenplayer/mediasources';
import Version from 'bigscreenplayer/version';
import Resizer from 'bigscreenplayer/resizer';
import ReadyHelper from 'bigscreenplayer/readyhelper';
import Subtitles from 'bigscreenplayer/subtitles/subtitles';
