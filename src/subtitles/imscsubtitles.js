import IMSC from 'bigscreenplayer/external/smp-imsc';
...
import Utils from 'bigscreenplayer/utils/playbackutils';
import LoadURL from 'bigscreenplayer/utils/loadurl';
import TimeUtils from 'bigscreenplayer/utils/timeutils';
    
    export default function (mediaPlayer, captions, autoStart, parentElement, defaultStyleOpts, windowStartEpochSeconds) {
